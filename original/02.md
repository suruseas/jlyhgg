...
If a function takes two parameters,
...
Because `+` works on integers as well as on floating-point numbers (anything that can be considered a number,
really),
...
If we wanted to write that in Haskell,
